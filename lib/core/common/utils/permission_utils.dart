import 'package:jewish_app/core/common/extensions/localization_extension.dart';
import 'package:jewish_app/core/ui/widgets/base/base_bottom_sheet.dart';
      ...
      return BaseBottomSheet(
        ...
        child: Column(
          ...
          children: [
            Text(
              permissionName != null
                  ? "specificPermissionRequired".trWithArgs({
            ...
            Text(
              permissionName != null
                  ? "makeSureSpecificPermissionGranted".trWithArgs({
                      "permissionName": permissionName,
                    })
