...
class BaseMessages extends StatefulWidget {
  const BaseMessages({super.key, required this.child});

  final Widget child;

  @override
  State<BaseMessages> createState() => _BaseMessagesState();
  ...
  static void show({
    ...
    context.findAncestorStateOfType<_BaseMessagesState>()?.show(
      message,
      isError,
      duration,
    );
...
class _BaseMessagesState extends State<BaseMessages>
            ...
            AnimatedPositioned(
              ...
              child: Container(
                ...
                padding: const EdgeInsets.only(
                  top: FIGMA_DESIGN_STATUS_BAR + 10,
                ),
                child: Stack(
                  children: [
                    Positioned.fill(
