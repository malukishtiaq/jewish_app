...
Future<dynamic> showMssBottomSheet({
...
class _BaseBottomSheetState<T> extends State<BaseBottomSheet> {
  ...
  @override
  void didUpdateWidget(BaseBottomSheet oldWidget) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: widget.titleContentSpacing ?? 8),
                      ...
                      for (int i = 0; i < widget.itemsLength!; i++) ...{
                        Container(
                          decoration: BoxDecoration(
                            ...
                            color:
                                widget.showSelectionBackground &&
