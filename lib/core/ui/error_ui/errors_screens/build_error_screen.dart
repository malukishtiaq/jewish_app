...
import 'package:jewish_app/core/ui/widgets/base/base_button.dart';
import 'package:jewish_app/core/ui/widgets/custom_image.dart';
import 'package:flutter/material.dart';
import 'package:lottie/lottie.dart';
import 'package:jewish_app/core/common/app_config.dart';
import 'package:jewish_app/core/constants/enums/app_options_enum.dart';
  ...
  switch (options.errorViewOption) {
    case ErrorWidgetOptions.IMAGE:
      if (imageUrl != null && imageUrl != "") {
        image = CustomImage.asset(imageUrl, height: 162, fit: BoxFit.contain);
      }
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        if (title != null) const SizedBox(height: 37),
        if (title != null)
          Text(
            title,
...
class ErrorAnimation {
  ...
  ErrorAnimation({required this.animUrl, required this.animationController});
}
