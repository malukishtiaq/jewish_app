...
import 'package:jewish_app/core/ui/dialogs/custom_dialogs.dart';
...
void showCustomErrorDialog({
  ...
  showCustomConfirmCancelDialog(
    ...
    onConfirm:
        errVDialogOptions.confirmOptions?.onBtnPressed ??
        (dContext) {
    ...
    onCancel:
        errVDialogOptions.cancelOptions?.onBtnPressed ??
